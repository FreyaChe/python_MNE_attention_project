...
# In[rest condition]
    ...
    np.savez('/Users/freya/Documents/GitHub/python_MNE_attention_project/PAC.npz', PAC_R=PAC_R, PAC_P=PAC_P)# save every round in case crush    

# In[statistic analysis: permutation test]
from scipy import sparse
from mne import spatial_src_adjacency
from scipy.sparse.csgraph import connected_components

data = np.load('/Users/freya/Documents/GitHub/python_MNE_attention_project/PAC.npz')
PAC_R = data['PAC_R']
PAC_P = data['PAC_P']
...
brain.save_image('/Users/freya/Documents/GitHub/python_MNE_attention_project/PAC_source_plot.png')
...
'''
G_temporal_inf-rh: 0.526
G_occipital_sup-lh: 0.390
S_front_inf-lh: 0.367
S_collat_transv_ant-rh: 0.346
S_postcentral-lh: 0.182
S_precentral-sup-part-rh: 0.170
G_postcentral-lh: 0.155
'''